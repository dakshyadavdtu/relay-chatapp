...
import { useSettingsStore } from "../adapters";
import { Heart, Star, Flame, Zap, ThumbsUp, ThumbsDown, Smile, Laugh, Frown, Angry, PartyPopper, Trophy, Lightbulb, Rocket, Target, Coffee, BookOpen, Music, Search, Gift, Check, Bell, Sun, Moon, Cloud } from "lucide-react";
...
export function EmojiPicker({ onSelect, onClose }) {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "bg-card border border-border rounded-xl shadow-xl w-[280px] max-h-[300px] overflow-y-auto p-3",
        !reducedMotion && "animate-in fade-in slide-in-from-bottom-2 duration-150"
      )}
        ...
        {REACTIONS.map((reaction) => {
          ...
          return (
            <button
              ...
              onClick={() => onSelect(reaction.text)}
              title={reaction.label}
              data-testid={`button-reaction-${reaction.label}`}
            >
